...
def room(request, pk):
    ...
    # if you want the messages in the ascending order then do this
    # room_messages = room.message_set.all().order_by('-created')
    # i personally want the messages order by default first message comes first
...
# added by me
def deleteRoomComment(request, room_pk, message_pk):
